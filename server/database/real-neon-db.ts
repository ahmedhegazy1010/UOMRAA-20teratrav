    ...
    if (Number(packageCount[0].count) === 0) {
      ...
      await sql`
        ...
        VALUES 
          ...
          ('رجب المبارك (فبراير)', '5 أيام / 4 ليالي', '3 ليالي - فندق دار التوحيد', '1 ليلة - فندق الطيبة سيتي', 'الرياض - المدين�� - مكة - جدة - الرياض', 3200, 2800, 2400, 1200, 2000, 'active', false, 'باقة قصيرة لشهر رجب المبارك مناسبة للرحلات السريعة'),
