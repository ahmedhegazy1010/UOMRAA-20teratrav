    ...
    if (packageCount[0].count === 0) {
      ...
      await sql`
        ...
        VALUES 
          ...
          ('عشر ذي الحجة (ديسمبر)', '8 أيام / 7 ليالي', '5 ليالي - برج الساعة فيرمونت', '2 ليالي - فندق الأنصار الذهبي', 'الرياض - ج��ة - مكة - المدينة - جدة - الرياض', 5200, 4500, 3900, 1800, 3400, 'active', false, 'باقة العشر الأوائل من ذي الحجة مع إقامة قريبة من الحرم المكي'),
