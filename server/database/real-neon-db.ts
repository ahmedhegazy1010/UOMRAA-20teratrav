    ...
    if (packageCount[0].count === 0) {
      ...
      await sql`
        ...
        VALUES 
          ...
          ('شعبان المبارك (مارس)', '6 أيام / 5 ليالي', '3 ليالي - فندق سويس أوتيل', '2 ليالي - ف��دق شذا المدينة', 'الرياض - جدة - مكة - المدينة - جدة - الرياض', 3800, 3300, 2900, 1400, 2500, 'active', false, 'باقة شهر شعبان مع ��دمات متميزة و��قامة مريحة')
      `;
